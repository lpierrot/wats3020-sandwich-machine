...
let bread = prompt ("what kid of bread do you want? (white, wheat, sour)", "white");
...
let toppings = prompt ("Enter comma separated lst of toppings (such as tomato, lettuce, onions):","lettuce, tomato, avocado");
